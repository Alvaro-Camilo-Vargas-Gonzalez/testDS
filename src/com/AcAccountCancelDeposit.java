...
import com.temenos.t24.AA_ACCOUNT_CANCEL_DEPOSIT_cl;
...
public class AcAccountCancelDeposit extends AA_ACCOUNT_CANCEL_DEPOSIT_cl {
    ...
    @Override
    protected int lbl_GET_ARRANGEMENT_RECORD() {
        
        return super.lbl_GET_ARRANGEMENT_RECORD();
    }
    ...
    @Override
    protected int lbl_GET_BILL_AND_DUE_AMOUNTS() {
        
        return super.lbl_GET_BILL_AND_DUE_AMOUNTS();
    }
    ...
    @Override
    protected int lbl_GET_RELATED_BILLS() {
        
        return super.lbl_GET_RELATED_BILLS();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_CANCEL_DEPOSIT_cl arg0) {
