...
import com.temenos.t24.AA_ACCOUNT_REDEEM_cl;
...
public class AaAccountRedeem extends AA_ACCOUNT_REDEEM_cl {
    ...
    @Override
    protected int lbl_ADJUST_PO_BALANCES() {
        
        return super.lbl_ADJUST_PO_BALANCES();
    }
    ...
    @Override
    protected int lbl_GET_EXPECTED_BILLS() {
        
        return super.lbl_GET_EXPECTED_BILLS();
    }

    @Override
    protected int lbl_GET_PROPERTY_AMOUNTS() {
        
        return super.lbl_GET_PROPERTY_AMOUNTS();
    }

    @Override
    protected int lbl_GET_VD_ADJUSTMENT_EVENT_TYPES() {
        
        return super.lbl_GET_VD_ADJUSTMENT_EVENT_TYPES();
    }
    ...
    @Override
    protected int lbl_PROCESS_VALUE_DATED_ADJUSTEMENTS() {
        
        return super.lbl_PROCESS_VALUE_DATED_ADJUSTEMENTS();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_REDEEM_cl arg0) {
