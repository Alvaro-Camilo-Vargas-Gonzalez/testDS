...
import com.temenos.t24.AA_ARR_CHARGE_OVERRIDE_cl;
import com.temenos.t24.component_AA_ChargeOverride_21_cl;
...
public class AaArrChargeOverride extends AA_ARR_CHARGE_OVERRIDE_cl {
    ...
    @Override
    public component_AA_ChargeOverride_21_cl getAA_ChargeOverride() {
        
        return super.getAA_ChargeOverride();
    }
    ...
    @Override
    public void stack(AA_ARR_CHARGE_OVERRIDE_cl arg0) {
