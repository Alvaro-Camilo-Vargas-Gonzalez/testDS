...
import com.temenos.t24.AA_ACCOUNT_CREATE_INVOICE_BALANCE_cl;
...
public class AaAccountCreateInvoiceBalance extends AA_ACCOUNT_CREATE_INVOICE_BALANCE_cl {
    ...
    @Override
    protected int lbl_GET_WORKING_BALANCE() {
        
        return super.lbl_GET_WORKING_BALANCE();
    }
    ...
    @Override
    protected int lbl_UPDATE_END_OF_PROCESS() {
        
        return super.lbl_UPDATE_END_OF_PROCESS();
    }

    @Override
    protected int lbl_UPDATE_INVOICE_BALANCE() {
        
        return super.lbl_UPDATE_INVOICE_BALANCE();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_CREATE_INVOICE_BALANCE_cl arg0) {
