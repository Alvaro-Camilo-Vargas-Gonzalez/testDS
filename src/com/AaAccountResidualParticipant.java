...
import com.temenos.t24.AA_ACCOUNT_RESIDUAL_PARTICIPANT_cl;
...
public class AaAccountResidualParticipant extends AA_ACCOUNT_RESIDUAL_PARTICIPANT_cl {
    ...
    @Override
    protected int lbl_GET_BALANCE_PREFIX() {
        
        return super.lbl_GET_BALANCE_PREFIX();
    }
    ...
    @Override
    protected int lbl_GET_OUTSTANDING_BALANCES() {
        
        return super.lbl_GET_OUTSTANDING_BALANCES();
    }

    @Override
    protected int lbl_GET_PARTICIPANT_BILLS() {
        
        return super.lbl_GET_PARTICIPANT_BILLS();
    }
    ...
    @Override
    protected int lbl_GET_RESIDUAL_AMOUNT() {
        
        return super.lbl_GET_RESIDUAL_AMOUNT();
    }
    ...
    @Override
    protected int lbl_PROCESS_BILLS_REVERSE() {
        
        return super.lbl_PROCESS_BILLS_REVERSE();
    }

    @Override
    protected int lbl_PROCESS_BILL_UPDATES() {
        
        return super.lbl_PROCESS_BILL_UPDATES();
    }
    ...
    @Override
    protected int lbl_SET_PARTICIPANT_DETAILS() {
        
        return super.lbl_SET_PARTICIPANT_DETAILS();
    }
    ...
    @Override
    protected int lbl_UPDATE_BILL_STATUS() {
        
        return super.lbl_UPDATE_BILL_STATUS();
    }

    @Override
    protected int lbl_UPDATE_PROPERTY_AMOUNTS() {
        
        return super.lbl_UPDATE_PROPERTY_AMOUNTS();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_RESIDUAL_PARTICIPANT_cl arg0) {
