...
import com.temenos.t24.AA_AF_COMMON_MANAGER_cl;
...
public class AaAfCommonManager extends AA_AF_COMMON_MANAGER_cl {
    ...
    @Override
    public int INSERT__I__AA_COMMON_SAVE() {
        
        return super.INSERT__I__AA_COMMON_SAVE();
    }

    @Override
    public int INSERT__I__AF_APP_COMMON() {
        
        return super.INSERT__I__AF_APP_COMMON();
    }

    @Override
    public int INSERT__I__AF_STANDARD_FIELDS() {
        
        return super.INSERT__I__AF_STANDARD_FIELDS();
    }
    ...
    @Override
    protected int lbl_CLEAR_AF_COMMONS() {
        
        return super.lbl_CLEAR_AF_COMMONS();
    }

    @Override
    protected int lbl_DO_PROCESS() {
        
        return super.lbl_DO_PROCESS();
    }
    ...
    @Override
    protected int lbl_PRESERVE_AF_COMMONS() {
        
        return super.lbl_PRESERVE_AF_COMMONS();
    }

    @Override
    protected int lbl_RESTORE_AF_COMMONS() {
        
        return super.lbl_RESTORE_AF_COMMONS();
    }
    ...
    @Override
    public void stack(AA_AF_COMMON_MANAGER_cl arg0) {
