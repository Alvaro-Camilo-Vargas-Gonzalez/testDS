...
import com.temenos.t24.AA_ADJUST_BILL_VALIDATE_cl;
...
public class AaAdjustBillValidate extends AA_ADJUST_BILL_VALIDATE_cl {
    ...
    @Override
    protected int lbl_GetBillIds() {
        
        return super.lbl_GetBillIds();
    }
    ...
    @Override
    protected int lbl_ValidateBillIds() {
        
        return super.lbl_ValidateBillIds();
    }
    ...
    @Override
    public void stack(AA_ADJUST_BILL_VALIDATE_cl arg0) {
