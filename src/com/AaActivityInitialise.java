...
import com.temenos.t24.AA_ACTIVITY_INITIALISE_cl;
import com.temenos.t24.component_AA_Fees_12_cl;
import com.temenos.t24.component_AA_Framework_17_cl;
import com.temenos.t24.component_AA_IntegrationFramework_27_cl;
...
public class AaActivityInitialise extends AA_ACTIVITY_INITIALISE_cl {
    ...
    @Override
    public component_AA_IntegrationFramework_27_cl getAA_IntegrationFramework() {
        
        return super.getAA_IntegrationFramework();
    }
    ...
    @Override
    protected int lbl_INITIALISE_AA_LOCAL_COMMONS() {
        
        return super.lbl_INITIALISE_AA_LOCAL_COMMONS();
    }

    @Override
    protected int lbl_INITIALISE_ACTION_CONTEXT() {
        
        return super.lbl_INITIALISE_ACTION_CONTEXT();
    }

    @Override
    protected int lbl_INITIALISE_ACTIVITY_COMMONS() {
        
        return super.lbl_INITIALISE_ACTIVITY_COMMONS();
    }

    @Override
    protected int lbl_INITIALISE_CACHE_COMMONS() {
        
        return super.lbl_INITIALISE_CACHE_COMMONS();
    }

    @Override
    protected int lbl_INITIALISE_FORWARD_COMMONS() {
        
        return super.lbl_INITIALISE_FORWARD_COMMONS();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_INITIALISE_cl arg0) {
