...
import com.temenos.t24.AA_ACTIVITY_STATUS_INTEGRITY_CHECK_cl;
...
public class AaActivityStatusIntegrityCheck extends AA_ACTIVITY_STATUS_INTEGRITY_CHECK_cl {
    ...
    @Override
    protected int lbl_DO_CHECKS() {
        
        return super.lbl_DO_CHECKS();
    }

    @Override
    protected int lbl_DetermineStatusCheck() {
        
        return super.lbl_DetermineStatusCheck();
    }
    ...
    @Override
    protected int lbl_RETRIEVE_PRE_POST_DETAILS() {
        
        return super.lbl_RETRIEVE_PRE_POST_DETAILS();
    }

    @Override
    protected int lbl_catchException() {
        
        return super.lbl_catchException();
    }

    @Override
    protected int lbl_doArrangementStatusCheck() {
        
        return super.lbl_doArrangementStatusCheck();
    }

    @Override
    protected int lbl_doSuspensionStatusCheck() {
        
        return super.lbl_doSuspensionStatusCheck();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_STATUS_INTEGRITY_CHECK_cl arg0) {
