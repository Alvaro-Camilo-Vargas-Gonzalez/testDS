...
import com.temenos.t24.AA_ACCOUNT_RESERVEFUNDS_cl;
...
public class AaAccountReservefunds extends AA_ACCOUNT_RESERVEFUNDS_cl {
    ...
    @Override
    protected int lbl_FORM_ENTRY_FOR_CHECKING() {
        
        return super.lbl_FORM_ENTRY_FOR_CHECKING();
    }
    ...
    @Override
    protected int lbl_PROCESS_AC_LOCKED_EVENT() {
        
        return super.lbl_PROCESS_AC_LOCKED_EVENT();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_RESERVEFUNDS_cl arg0) {
