...
import com.temenos.t24.AA_ACCOUNT_DUE_NOTICE_cl;
...
public class AaAccountDueNotice extends AA_ACCOUNT_DUE_NOTICE_cl {
    ...
    @Override
    protected int lbl_BuildAccountingUpdate() {
        
        return super.lbl_BuildAccountingUpdate();
    }

    @Override
    protected int lbl_GetBalanceTypes() {
        
        return super.lbl_GetBalanceTypes();
    }
    ...
    @Override
    protected int lbl_GetBillPropertyAmount() {
        
        return super.lbl_GetBillPropertyAmount();
    }
    ...
    @Override
    protected int lbl_UpdatePropertyAmount() {
        
        return super.lbl_UpdatePropertyAmount();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_DUE_NOTICE_cl arg0) {
