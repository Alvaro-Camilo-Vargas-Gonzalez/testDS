...
import com.temenos.t24.AA_ACTIVITY_CHARGES_VALIDATE_BUNDLE_HIERARCHY_cl;
...
public class AaActivityChargesValidateBundleHierachy extends AA_ACTIVITY_CHARGES_VALIDATE_BUNDLE_HIERARCHY_cl {
    ...
    @Override
    protected int lbl_ValidateAmortisation() {
        
        return super.lbl_ValidateAmortisation();
    }

    @Override
    protected int lbl_ValidateAutoSettle() {
        
        return super.lbl_ValidateAutoSettle();
    }

    @Override
    protected int lbl_ValidateCapitalisation() {
        
        return super.lbl_ValidateCapitalisation();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_CHARGES_VALIDATE_BUNDLE_HIERARCHY_cl arg0) {
