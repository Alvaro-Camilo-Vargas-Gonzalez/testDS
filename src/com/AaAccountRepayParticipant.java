...
import com.temenos.t24.AA_ACCOUNT_REPAY_PARTICIPANT_cl;
...
public class AaAccountRepayParticipant extends AA_ACCOUNT_REPAY_PARTICIPANT_cl {
    ...
    @Override
    protected int lbl_PROCESS_CURRENT_AMOUNTS() {
        
        return super.lbl_PROCESS_CURRENT_AMOUNTS();
    }
    ...
    @Override
    protected int lbl_RAISE_PARTICIPANT_SPEICAL_ENTRIES() {
        
        return super.lbl_RAISE_PARTICIPANT_SPEICAL_ENTRIES();
    }

    @Override
    protected int lbl_RAISE_ROUNDING_AMT() {
        
        return super.lbl_RAISE_ROUNDING_AMT();
    }

    @Override
    protected int lbl_RAISE_ROUNDING_ENTIRES() {
        
        return super.lbl_RAISE_ROUNDING_ENTIRES();
    }

    @Override
    protected int lbl_RAISE_SUSP_ENTRY_FOR_PARTICIPANT() {
        
        return super.lbl_RAISE_SUSP_ENTRY_FOR_PARTICIPANT();
    }
    ...
    @Override
    protected int lbl_VERIFY_PARTICIPANT_BILLS() {
        
        return super.lbl_VERIFY_PARTICIPANT_BILLS();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_REPAY_PARTICIPANT_cl arg0) {
