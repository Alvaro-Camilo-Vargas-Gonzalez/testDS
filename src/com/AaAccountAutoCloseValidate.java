...
import com.temenos.t24.AA_ACCOUNT_AUTO_CLOSE_VALIDATE_cl;
...
public class AaAccountAutoCloseValidate extends AA_ACCOUNT_AUTO_CLOSE_VALIDATE_cl {
    ...
    @Override
    protected int lbl_GetCurBalanceType() {
        
        return super.lbl_GetCurBalanceType();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_AUTO_CLOSE_VALIDATE_cl arg0) {
