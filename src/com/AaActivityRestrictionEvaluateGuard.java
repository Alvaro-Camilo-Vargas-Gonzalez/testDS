...
import com.temenos.t24.AA_ACTIVITY_RESTRICTION_EVALUATE_GUARD_cl;
...
public class AaActivityRestrictionEvaluateGuard extends AA_ACTIVITY_RESTRICTION_EVALUATE_GUARD_cl {
    ...
    @Override
    protected int lbl_CheckReqDetails() {
        
        return super.lbl_CheckReqDetails();
    }

    @Override
    protected int lbl_CheckRestrictionRequired() {
        
        return super.lbl_CheckRestrictionRequired();
    }

    @Override
    protected int lbl_GetActivity() {
        
        return super.lbl_GetActivity();
    }

    @Override
    protected int lbl_GetRestrictionSetup() {
        
        return super.lbl_GetRestrictionSetup();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_RESTRICTION_EVALUATE_GUARD_cl arg0) {
