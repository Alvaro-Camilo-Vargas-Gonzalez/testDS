...
import com.temenos.t24.AA_ACCOUNT_ALLOCATE_cl;
...
public class AaAccountAllocate extends AA_ACCOUNT_ALLOCATE_cl {
    ...
    @Override
    protected int lbl_CUR_BALANCE_TYPE() {
       
        return super.lbl_CUR_BALANCE_TYPE();
    }

    @Override
    protected int lbl_EXTERNAL_ACTIVITY() {
       
        return super.lbl_EXTERNAL_ACTIVITY();
    }

    @Override
    protected int lbl_GET_ARR_BALANCE_AMT() {
       
        return super.lbl_GET_ARR_BALANCE_AMT();
    }
    ...
    @Override
    protected int lbl_PROCESS_REV_DELETE_ACTION() {
       
        return super.lbl_PROCESS_REV_DELETE_ACTION();
    }
    ...
    @Override
    protected int lbl_SET_TXN_AMOUNT() {
       
        return super.lbl_SET_TXN_AMOUNT();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_ALLOCATE_cl arg0) {
