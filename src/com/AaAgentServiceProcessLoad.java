...
import com.temenos.t24.AA_AGENT_SERVICE_PROCESS_LOAD_cl;
...
public class AaAgentServiceProcessLoad extends AA_AGENT_SERVICE_PROCESS_LOAD_cl {
    ...
    @Override
    protected int lbl_LOAD_COB_COMMON() {
        
        return super.lbl_LOAD_COB_COMMON();
    }

    @Override
    protected int lbl_OPEN_FILES() {
        
        return super.lbl_OPEN_FILES();
    }
    ...
    @Override
    public void stack(AA_AGENT_SERVICE_PROCESS_LOAD_cl arg0) {
