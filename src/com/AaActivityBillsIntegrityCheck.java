...
import com.temenos.t24.AA_ACTIVITY_BILLS_INTEGRITY_CHECK_cl;
...
public class AaActivityBillsIntegrityCheck extends AA_ACTIVITY_BILLS_INTEGRITY_CHECK_cl {
    ...
    @Override
    protected int lbl_BILLS_EXCLUSIVE_CHECKS() {
        
        return super.lbl_BILLS_EXCLUSIVE_CHECKS();
    }

    @Override
    protected int lbl_DO_BILLS_CHECK() {
        
        return super.lbl_DO_BILLS_CHECK();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_BILLS_INTEGRITY_CHECK_cl arg0) {
