...
import com.temenos.t24.AA_ACCOUNT_ISSUE_ROLLOVER_BILL_cl;
...
public class AaAccountIssueRolloverBill extends AA_ACCOUNT_ISSUE_ROLLOVER_BILL_cl {
    ...
    @Override
    protected int lbl_FORM_BILL_DETAILS() {
        
        return super.lbl_FORM_BILL_DETAILS();
    }
    ...
    @Override
    protected int lbl_GET_ROLLOVER_AMOUNT() {
        
        return super.lbl_GET_ROLLOVER_AMOUNT();
    }

    @Override
    protected int lbl_GET_SHARE_TRANSFER_DETAILS() {
        
        return super.lbl_GET_SHARE_TRANSFER_DETAILS();
    }
    ...
    @Override
    protected int lbl_UPDATE_SCHEDULE_ACTIVITY() {
        
        return super.lbl_UPDATE_SCHEDULE_ACTIVITY();
    }

    @Override
    protected int lbl_UPDATE_SECONDARY_ACTIVITY() {
        
        return super.lbl_UPDATE_SECONDARY_ACTIVITY();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_ISSUE_ROLLOVER_BILL_cl arg0) {
