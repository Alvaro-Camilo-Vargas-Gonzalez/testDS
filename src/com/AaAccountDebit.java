...
import com.temenos.t24.AA_ACCOUNT_DEBIT_cl;
...
public class AaAccountDebit extends AA_ACCOUNT_DEBIT_cl {
    ...
    @Override
    protected int lbl_CALCULATE_LCY_AMOUNT() {

        return super.lbl_CALCULATE_LCY_AMOUNT();
    }
    ...
    @Override
    protected int lbl_GET_TXN_AMOUNT() {

        return super.lbl_GET_TXN_AMOUNT();
    }
    ...
    @Override
    protected int lbl_UPDATE_AAA_REC() {

        return super.lbl_UPDATE_AAA_REC();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_DEBIT_cl arg0) {
