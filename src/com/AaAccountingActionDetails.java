...
import com.temenos.t24.AA_ACCOUNTING_ACTION_DETAILS_cl;
...
public class AaAccountingActionDetails extends AA_ACCOUNTING_ACTION_DETAILS_cl {
    ...
    @Override
    protected int lbl_BUILD_EVENT_ARRAY() {
        
        return super.lbl_BUILD_EVENT_ARRAY();
    }

    @Override
    protected int lbl_BUILD_PAYMENT_METHOD() {
        
        return super.lbl_BUILD_PAYMENT_METHOD();
    }

    @Override
    protected int lbl_GET_ACCOUNTING_RULE() {
        
        return super.lbl_GET_ACCOUNTING_RULE();
    }

    @Override
    protected int lbl_GET_ALLOCATION_RULE_ID() {
        
        return super.lbl_GET_ALLOCATION_RULE_ID();
    }
    ...
    @Override
    protected int lbl_GET_EVENT_TYPE_LIST() {
        
        return super.lbl_GET_EVENT_TYPE_LIST();
    }
    ...
    @Override
    protected int lbl_LOCATE_ALLOCATION_RULE() {
        
        return super.lbl_LOCATE_ALLOCATION_RULE();
    }

    @Override
    protected int lbl_LOCATE_EVENT_TYPE() {
        
        return super.lbl_LOCATE_EVENT_TYPE();
    }
    ...
    @Override
    public void stack(AA_ACCOUNTING_ACTION_DETAILS_cl arg0) {
