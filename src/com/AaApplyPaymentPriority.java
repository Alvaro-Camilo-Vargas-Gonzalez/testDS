...
import com.temenos.t24.AA_APPLY_PAYMENT_PRIORITY_cl;
...
public class AaApplyPaymentPriority extends AA_APPLY_PAYMENT_PRIORITY_cl {
    ...
    @Override
    protected int lbl_BuildActivityId() {
        
        return super.lbl_BuildActivityId();
    }

    @Override
    protected int lbl_BuildNewArrActivityId() {
        
        return super.lbl_BuildNewArrActivityId();
    }

    @Override
    protected int lbl_BuildSecondaryActivityRecord() {
        
        return super.lbl_BuildSecondaryActivityRecord();
    }
    ...
    @Override
    public void stack(AA_APPLY_PAYMENT_PRIORITY_cl arg0) {
