...
import com.temenos.t24.AA_ACCOUNTING_OVERRIDES_cl;
...
public class AaAccountingOverrides extends AA_ACCOUNTING_OVERRIDES_cl {
    ...
    @Override
    protected int lbl_PROCESS_OVERRIDE() {
        
        return super.lbl_PROCESS_OVERRIDE();
    }
    ...
    @Override
    public void stack(AA_ACCOUNTING_OVERRIDES_cl arg0) {
