...
import com.temenos.t24.AA_ACCOUNT_CR_MOVEMENT_GUARD_cl;
...
public class AaAccountCrMovementGuard extends AA_ACCOUNT_CR_MOVEMENT_GUARD_cl {
    ...
    @Override
    protected int lbl_CheckDirectAccounting() {
        
        return super.lbl_CheckDirectAccounting();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_CR_MOVEMENT_GUARD_cl arg0) {
