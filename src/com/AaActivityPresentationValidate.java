...
import com.temenos.t24.AA_ACTIVITY_PRESENTATION_VALIDATE_cl;
import com.temenos.t24.component_AA_ActivityPresentation_27_cl;
...
public class AaActivityPresentationValidate extends AA_ACTIVITY_PRESENTATION_VALIDATE_cl {
    ...
    @Override
    public component_AA_ActivityPresentation_27_cl getAA_ActivityPresentation() {
        
        return super.getAA_ActivityPresentation();
    }
    ...
    @Override
    protected int lbl_CHECK_ACTIVITY_PROPERTY_VERSION() {
        
        return super.lbl_CHECK_ACTIVITY_PROPERTY_VERSION();
    }

    @Override
    protected int lbl_CHECK_ACTIVITY_VERSION() {
        
        return super.lbl_CHECK_ACTIVITY_VERSION();
    }

    @Override
    protected int lbl_CHECK_FOR_MAND_FIELDS() {
        
        return super.lbl_CHECK_FOR_MAND_FIELDS();
    }

    @Override
    protected int lbl_CHECK_HIDE_PROPERTY_VERSIONS() {
        
        return super.lbl_CHECK_HIDE_PROPERTY_VERSIONS();
    }

    @Override
    protected int lbl_CHECK_PROPERTY_CLASS_VERSION() {
        
        return super.lbl_CHECK_PROPERTY_CLASS_VERSION();
    }

    @Override
    protected int lbl_CHECK_PROPERTY_VERSION() {
        
        return super.lbl_CHECK_PROPERTY_VERSION();
    }
    ...
    @Override
    protected int lbl_ERROR_HANDLER() {
        
        return super.lbl_ERROR_HANDLER();
    }

    @Override
    protected int lbl_GENERIC_CROSSVAL() {
        
        return super.lbl_GENERIC_CROSSVAL();
    }

    @Override
    protected int lbl_GET_PROPERTY_CLASS_NAME() {
        
        return super.lbl_GET_PROPERTY_CLASS_NAME();
    }

    @Override
    protected int lbl_GET_SYSTEM_ACTIVITY_ID() {
        
        return super.lbl_GET_SYSTEM_ACTIVITY_ID();
    }

    @Override
    protected int lbl_HIDE_PROPERTY_VALIDATIONS() {
        
        return super.lbl_HIDE_PROPERTY_VALIDATIONS();
    }
    ...
    @Override
    protected int lbl_PROPERTY_CLASS_TYPE_VALIDATIONS() {
        
        return super.lbl_PROPERTY_CLASS_TYPE_VALIDATIONS();
    }
    ...
    @Override
    protected int lbl_VALIDATE_HIDE_FIELDS() {
        
        return super.lbl_VALIDATE_HIDE_FIELDS();
    }

    @Override
    protected int lbl_VALIDATE_VERSION_NAME() {
        
        return super.lbl_VALIDATE_VERSION_NAME();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_PRESENTATION_VALIDATE_cl arg0) {
