...
import com.temenos.t24.AA_ACCOUNT_DETAILS_SUSPEND_cl;
...
public class AaAccountDetailsSuspend extends AA_ACCOUNT_DETAILS_SUSPEND_cl {
    ...
    @Override
    protected int lbl_CHECK_REQUIRED_INFO() {
        
        return super.lbl_CHECK_REQUIRED_INFO();
    }
    ...
    @Override
    protected int lbl_REVERSE_DETAILS() {
        
        return super.lbl_REVERSE_DETAILS();
    }

    @Override
    protected int lbl_UPDATE_DETAILS() {
        
        return super.lbl_UPDATE_DETAILS();
    }

    @Override
    protected int lbl_UPDATE_SUSPENEDED_BY() {
        
        return super.lbl_UPDATE_SUSPENEDED_BY();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_DETAILS_SUSPEND_cl arg0) {
