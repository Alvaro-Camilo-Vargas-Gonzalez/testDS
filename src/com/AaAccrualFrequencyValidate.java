...
import com.temenos.t24.AA_ACCRUAL_FREQUENCY_VALIDATE_cl;
...
public class AaAccrualFrequencyValidate extends AA_ACCRUAL_FREQUENCY_VALIDATE_cl {
    ...
    @Override
    protected int lbl_CHECK_FREQUENCY() {
        
        return super.lbl_CHECK_FREQUENCY();
    }

    @Override
    protected int lbl_CHECK_INFO_PROPERTY() {
        
        return super.lbl_CHECK_INFO_PROPERTY();
    }
    ...
    @Override
    protected int lbl_VALIDATE_FREQUENCY() {
        
        return super.lbl_VALIDATE_FREQUENCY();
    }
    ...
    @Override
    public void stack(AA_ACCRUAL_FREQUENCY_VALIDATE_cl arg0) {
