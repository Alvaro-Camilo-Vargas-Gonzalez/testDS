...
import com.temenos.t24.AA_ACCOUNT_DETAILS_DELETE_cl;
...
public class AaAccountDetailsDelete extends AA_ACCOUNT_DETAILS_DELETE_cl {
    ...
    @Override
    public jVar invoke(java.lang.Object arg0, java.lang.Object arg1) {
    ...
    @Override
    protected int lbl_ImageHandOff() {
        
        return super.lbl_ImageHandOff();
    }

    @Override
    protected int lbl_globalValidate() {
        
        return super.lbl_globalValidate();
    }

    @Override
    protected int lbl_tableOperation() {
        
        return super.lbl_tableOperation();
    }

    @Override
    protected int lbl_tableValidate() {
        
        return super.lbl_tableValidate();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_DETAILS_DELETE_cl arg0) {
