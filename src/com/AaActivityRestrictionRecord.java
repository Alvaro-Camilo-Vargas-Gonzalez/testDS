...
import com.temenos.t24.AA_ACTIVITY_RESTRICTION_RECORD_cl;
...
public class AaActivityRestrictionRecord extends AA_ACTIVITY_RESTRICTION_RECORD_cl {
    ...
    @Override
    protected int lbl_ProcessRecord() {
        
        return super.lbl_ProcessRecord();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_RESTRICTION_RECORD_cl arg0) {
