...
import com.temenos.t24.AA_APPLY_PRICING_BENEFIT_cl;
import com.temenos.t24.component_AA_PricingRules_19_cl;
import com.temenos.t24.component_EB_Reports_15_cl;
import com.temenos.tafj.common.jSession;
import com.temenos.tafj.common.jVar;

public class AaApplyPricingBenefit extends AA_APPLY_PRICING_BENEFIT_cl {
    ...
    @Override
    public component_EB_Reports_15_cl getEB_Reports() {
        
        return super.getEB_Reports();
    }
    ...
    @Override
    protected int lbl_APPLY_BENEFIT_TO_PROPERTIES() {
        
        return super.lbl_APPLY_BENEFIT_TO_PROPERTIES();
    }

    @Override
    protected int lbl_BUILD_PRICING_INFO() {
        
        return super.lbl_BUILD_PRICING_INFO();
    }

    @Override
    protected int lbl_GET_PRICING_VALUES() {
        
        return super.lbl_GET_PRICING_VALUES();
    }
    ...
    @Override
    protected int lbl_PROCESS_CHARGE() {
        
        return super.lbl_PROCESS_CHARGE();
    }

    @Override
    protected int lbl_PROCESS_CHARGE_PROPERTIES() {
        
        return super.lbl_PROCESS_CHARGE_PROPERTIES();
    }

    @Override
    protected int lbl_PROCESS_INTEREST() {
       
        return super.lbl_PROCESS_INTEREST();
    }

    @Override
    protected int lbl_PROCESS_INT_PROPERTIES() {
        
        return super.lbl_PROCESS_INT_PROPERTIES();
    }

    @Override
    protected int lbl_PROCESS_PERIODIC_CHARGES_PROPERTIES() {
        
        return super.lbl_PROCESS_PERIODIC_CHARGES_PROPERTIES();
    }
    ...
    @Override
    public void stack(AA_APPLY_PRICING_BENEFIT_cl arg0) {
