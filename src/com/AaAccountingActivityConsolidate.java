...
import com.temenos.t24.AA_ACCOUNTING_ACTIVITY_CONSOLIDATE_cl;
...
public class AaAccountingActivityConsolidate extends AA_ACCOUNTING_ACTIVITY_CONSOLIDATE_cl {
    ...
    @Override
    protected int lbl_CONSOLIDATE() {
        
        return super.lbl_CONSOLIDATE();
    }

    @Override
    protected int lbl_DETERMINE_AAA_ID() {
        
        return super.lbl_DETERMINE_AAA_ID();
    }
    ...
    @Override
    protected int lbl_SEARCH_ACTIVITY_HISTORY() {
        
        return super.lbl_SEARCH_ACTIVITY_HISTORY();
    }

    @Override
    protected int lbl_SET_AC_HVT_TRIGGER_ID() {
        
        return super.lbl_SET_AC_HVT_TRIGGER_ID();
    }
    ...
    @Override
    public void stack(AA_ACCOUNTING_ACTIVITY_CONSOLIDATE_cl arg0) {
