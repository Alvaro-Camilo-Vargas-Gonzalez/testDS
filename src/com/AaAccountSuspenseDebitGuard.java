...
import com.temenos.t24.AA_ACCOUNT_SUSPENSE_DEBIT_GUARD_cl;
...
public class AaAccountSuspenseDebitGuard extends AA_ACCOUNT_SUSPENSE_DEBIT_GUARD_cl {
    ...
    @Override
    protected int lbl_ValidateSystem() {
        
        return super.lbl_ValidateSystem();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_SUSPENSE_DEBIT_GUARD_cl arg0) {
