...
import com.temenos.t24.AA_ACCOUNT_DETAILS_FIELDS_cl;
...
import com.temenos.t24.component_ST_OrganizationStructure_28_cl;
import com.temenos.tafj.common.jSession;
import com.temenos.tafj.common.jVar;

public class AaAccountDetailsFields extends AA_ACCOUNT_DETAILS_FIELDS_cl {
    ...
    @Override
    public component_ST_OrganizationStructure_28_cl getST_OrganizationStructure() {
        
        return super.getST_OrganizationStructure();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_DETAILS_FIELDS_cl arg0) {
