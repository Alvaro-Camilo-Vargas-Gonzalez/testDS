...
import com.temenos.t24.AA_ADD_EXTERNAL_ACTION_cl;
...
public class AaAddExternalAction extends AA_ADD_EXTERNAL_ACTION_cl {
    ...
    @Override
    protected int lbl_AddExternalAction() {
        
        return super.lbl_AddExternalAction();
    }
    ...
    @Override
    protected int lbl_HandelException() {
        
        return super.lbl_HandelException();
    }
    ...
    @Override
    protected int lbl_ValidateInputs() {
        
        return super.lbl_ValidateInputs();
    }
    ...
    @Override
    public void stack(AA_ADD_EXTERNAL_ACTION_cl arg0) {
