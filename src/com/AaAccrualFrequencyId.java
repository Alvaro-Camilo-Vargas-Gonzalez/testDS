...
import com.temenos.t24.AA_ACCRUAL_FREQUENCY_ID_cl;
...
public class AaAccrualFrequencyId extends AA_ACCRUAL_FREQUENCY_ID_cl {
    ...
    @Override
    protected int lbl_FORMAT_ID() {
        
        return super.lbl_FORMAT_ID();
    }
    ...
    @Override
    public void stack(AA_ACCRUAL_FREQUENCY_ID_cl arg0) {
