...
import com.temenos.t24.AA_ACTIVITY_RESTRICTION_MAINTAIN_cl;
...
import com.temenos.t24.component_AA_Rules_13_cl;
...
public class AaActivityRestrictionMaintain extends AA_ACTIVITY_RESTRICTION_MAINTAIN_cl {
    ...
    @Override
    public component_AA_Rules_13_cl getAA_Rules() {
        
        return super.getAA_Rules();
    }
    ...
    @Override
    protected int lbl_DELETE_SCHEDULED_ACTIVITY() {
        
        return super.lbl_DELETE_SCHEDULED_ACTIVITY();
    }

    @Override
    protected int lbl_GET_LAST_DATE() {
        
        return super.lbl_GET_LAST_DATE();
    }

    @Override
    protected int lbl_GET_SCHEDULE_MODE() {
        
        return super.lbl_GET_SCHEDULE_MODE();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_RESTRICTION_MAINTAIN_cl arg0) {
