...
import com.temenos.t24.AA_APPLY_INTEREST_PRICING_cl;
...
public class AaApplyInterestPricing extends AA_APPLY_INTEREST_PRICING_cl {
    ...
    @Override
    protected int lbl_GET_MARGIN_RATE() {
        
        return super.lbl_GET_MARGIN_RATE();
    }
    ...
    @Override
    public void stack(AA_APPLY_INTEREST_PRICING_cl arg0) {
