...
import com.temenos.t24.AA_ACCOUNT_OFFSET_INVOICE_BALANCE_cl;
...
public class AaAccountOffsetInvoiceBalance extends AA_ACCOUNT_OFFSET_INVOICE_BALANCE_cl {
    ...
    @Override
    protected int lbl_BUILD_PAYOFF_INVOICE_ENTRY() {
        
        return super.lbl_BUILD_PAYOFF_INVOICE_ENTRY();
    }
    ...
    @Override
    protected int lbl_GET_OLDEST_PAYMENT_DATE() {
        
        return super.lbl_GET_OLDEST_PAYMENT_DATE();
    }

    @Override
    protected int lbl_GET_PROPERTIES_AMOUNT() {
        
        return super.lbl_GET_PROPERTIES_AMOUNT();
    }

    @Override
    protected int lbl_GET_PROP_AMT() {
        
        return super.lbl_GET_PROP_AMT();
    }
    ...
    @Override
    protected int lbl_PROCESS_ACCOUNTING_ENTRIES() {
        
        return super.lbl_PROCESS_ACCOUNTING_ENTRIES();
    }
    ...
    @Override
    protected int lbl_PROCESS_INVOICE_AMOUNT() {
        
        return super.lbl_PROCESS_INVOICE_AMOUNT();
    }

    @Override
    protected int lbl_PROCESS_INVOICE_BALANCE() {
        
        return super.lbl_PROCESS_INVOICE_BALANCE();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_OFFSET_INVOICE_BALANCE_cl arg0) {
