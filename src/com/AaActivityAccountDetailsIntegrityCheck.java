...
import com.temenos.t24.AA_ACTIVITY_ACCOUNT_DETAILS_INTEGRITY_CHECK_cl;
import com.temenos.t24.component_AA_Framework_17_cl;
import com.temenos.t24.component_AA_Interfaces_18_cl;
...
public class AaActivityAccountDetailsIntegrityCheck extends AA_ACTIVITY_ACCOUNT_DETAILS_INTEGRITY_CHECK_cl {
    ...
    @Override
    public component_AA_Interfaces_18_cl getAA_Interfaces() {
        
        return super.getAA_Interfaces();
    }
    ...
    @Override
    protected int lbl_CheckDownpayment() {
        
        return super.lbl_CheckDownpayment();
    }
    ...
    @Override
    protected int lbl_RetrievePrePostDetails() {
        
        return super.lbl_RetrievePrePostDetails();
    }

    @Override
    protected int lbl_VerifyAgeStatus() {
        
        return super.lbl_VerifyAgeStatus();
    }

    @Override
    protected int lbl_VerifyBillDetails() {
        
        return super.lbl_VerifyBillDetails();
    }

    @Override
    protected int lbl_VerifyPaymentTypes() {
        
        return super.lbl_VerifyPaymentTypes();
    }

    @Override
    protected int lbl_VerifyPeriodicResetActivity() {
        
        return super.lbl_VerifyPeriodicResetActivity();
    }

    @Override
    protected int lbl_VerifySetOverdue() {
        
        return super.lbl_VerifySetOverdue();
    }

    @Override
    protected int lbl_init() {
        
        return super.lbl_init();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_ACCOUNT_DETAILS_INTEGRITY_CHECK_cl arg0) {
