...
import com.temenos.t24.AA_ACCOUNT_BALANCE_MOVEMENT_cl;
...
public class AaAccountBalanceMovement extends AA_ACCOUNT_BALANCE_MOVEMENT_cl {
    ...
    @Override
    protected int lbl_BAL_MOMENT_TO_AR() {
        
        return super.lbl_BAL_MOMENT_TO_AR();
    }
    ...
    @Override
    protected int lbl_GET_AC_BALANCE() {
        
        return super.lbl_GET_AC_BALANCE();
    }

    @Override
    protected int lbl_GET_AC_TO_AR_IND() {
        
        return super.lbl_GET_AC_TO_AR_IND();
    }
    ...
    @Override
    protected int lbl_GET_FWD_ENTREIS() {
        
        return super.lbl_GET_FWD_ENTREIS();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_BALANCE_MOVEMENT_cl arg0) {
