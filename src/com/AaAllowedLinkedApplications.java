...
import com.temenos.t24.AA_ALLOWED_LINKED_APPLICATIONS_cl;
...
public class AaAllowedLinkedApplications extends AA_ALLOWED_LINKED_APPLICATIONS_cl {
    ...
    @Override
    protected int lbl_PropertyClassApplication() {
        
        return super.lbl_PropertyClassApplication();
    }
    ...
    @Override
    public void stack(AA_ALLOWED_LINKED_APPLICATIONS_cl arg0) {
