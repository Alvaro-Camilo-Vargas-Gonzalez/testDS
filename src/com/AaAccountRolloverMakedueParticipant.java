...
import com.temenos.t24.AA_ACCOUNT_ROLLOVER_MAKEDUE_PARTICIPANT_cl;
...
public class AaAccountRolloverMakedueParticipant extends AA_ACCOUNT_ROLLOVER_MAKEDUE_PARTICIPANT_cl {
    ...
    @Override
    protected int lbl_GetBillParticipantDetails() {
        
        return super.lbl_GetBillParticipantDetails();
    }

    @Override
    protected int lbl_GetBorrowerBillAmount() {
        
        return super.lbl_GetBorrowerBillAmount();
    }

    @Override
    protected int lbl_GetBorrowerBillDetails() {
        
        return super.lbl_GetBorrowerBillDetails();
    }

    @Override
    protected int lbl_GetBorrowerDueAmount() {
        
        return super.lbl_GetBorrowerDueAmount();
    }
    ...
    @Override
    protected int lbl_GetParticipantsDetails() {
        
        return super.lbl_GetParticipantsDetails();
    }
    ...
    @Override
    protected int lbl_GetSourceRolloverAmount() {
        
        return super.lbl_GetSourceRolloverAmount();
    }
    ...
    @Override
    protected int lbl_MakeBillDue() {
        
        return super.lbl_MakeBillDue();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_ROLLOVER_MAKEDUE_PARTICIPANT_cl arg0) {
