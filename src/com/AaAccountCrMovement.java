...
import com.temenos.t24.AA_ACCOUNT_CR_MOVEMENT_cl;
...
public class AaAccountCrMovement extends AA_ACCOUNT_CR_MOVEMENT_cl {
    ...
    @Override
    protected int lbl_PROCESS_LINK_ACCOUNT_DEBIT() {
        
        return super.lbl_PROCESS_LINK_ACCOUNT_DEBIT();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_CR_MOVEMENT_cl arg0) {
