...
import com.temenos.t24.AA_ADJUST_TAX_COMMON_cl;
...
public class AaAdjustTaxCommon extends AA_ADJUST_TAX_COMMON_cl {
    ...
    @Override
    protected int lbl_AdjustTaxcommon() {
        
        return super.lbl_AdjustTaxcommon();
    }
    ...
    @Override
    protected int lbl_ReadActivityBalance() {
        
        return super.lbl_ReadActivityBalance();
    }

    @Override
    protected int lbl_UpdateAmountAndIndicator() {
        
        return super.lbl_UpdateAmountAndIndicator();
    }
    ...
    @Override
    public void stack(AA_ADJUST_TAX_COMMON_cl arg0) {
