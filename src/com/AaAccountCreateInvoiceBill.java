...
import com.temenos.t24.AA_ACCOUNT_CREATE_INVOICE_BILL_cl;
...
public class AaAccountCreateInvoiceBill extends AA_ACCOUNT_CREATE_INVOICE_BILL_cl {
    ...
    @Override
    protected int lbl_CALL_BILLS_MANAGER() {
        
        return super.lbl_CALL_BILLS_MANAGER();
    }
    ...
    @Override
    protected int lbl_GET_INVOICE_BILLS() {
        
        return super.lbl_GET_INVOICE_BILLS();
    }

    @Override
    protected int lbl_GET_PROPERTY_IDS() {
        
        return super.lbl_GET_PROPERTY_IDS();
    }
    ...
    @Override
    protected int lbl_REVERSE_INVOICE_BILLS() {
        
        return super.lbl_REVERSE_INVOICE_BILLS();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_CREATE_INVOICE_BILL_cl arg0) {
