...
import com.temenos.t24.AA_ACCOUNT_CHARGEOFF_cl;
...
public class AaAccountChargeoff extends AA_ACCOUNT_CHARGEOFF_cl {
    ...
    @Override
    protected int lbl_BUILD_CO_ACCOUNTING_UPDATE() {
        
        return super.lbl_BUILD_CO_ACCOUNTING_UPDATE();
    }

    @Override
    protected int lbl_BUILD_CUST_ACCOUNTING_UPDATES() {
        
        return super.lbl_BUILD_CUST_ACCOUNTING_UPDATES();
    }

    @Override
    protected int lbl_BUILD_PRINCIPAL_CO_ENTRY() {
        
        return super.lbl_BUILD_PRINCIPAL_CO_ENTRY();
    }
    ...
    @Override
    protected int lbl_CHECK_BILL_DETAILS() {
        
        return super.lbl_CHECK_BILL_DETAILS();
    }

    @Override
    protected int lbl_CHECK_PARTIAL_CHARGEOFF() {
        
        return super.lbl_CHECK_PARTIAL_CHARGEOFF();
    }

    @Override
    protected int lbl_CHECK_PARTICIPANTS() {
        
        return super.lbl_CHECK_PARTICIPANTS();
    }
    ...
    @Override
    protected int lbl_PROCESS_BILLS_ACCOUNTING() {
        
        return super.lbl_PROCESS_BILLS_ACCOUNTING();
    }

    @Override
    protected int lbl_PROCESS_CURRENT_BALANCES_CO_ENTRY() {
        
        return super.lbl_PROCESS_CURRENT_BALANCES_CO_ENTRY();
    }

    @Override
    protected int lbl_PROCESS_CURRENT_BALANCE_ACCOUNTING() {
        
        return super.lbl_PROCESS_CURRENT_BALANCE_ACCOUNTING();
    }
    ...
    @Override
    protected int lbl_RAISE_ACCOUNTING() {
        
        return super.lbl_RAISE_ACCOUNTING();
    }

    @Override
    protected int lbl_RAISE_CHARGEOFF_ENTRIES() {
        
        return super.lbl_RAISE_CHARGEOFF_ENTRIES();
    }

    @Override
    protected int lbl_RAISE_CO_ENTRIES() {
        
        return super.lbl_RAISE_CO_ENTRIES();
    }

    @Override
    protected int lbl_RAISE_CUSTOMER_ENTRIES() {
        
        return super.lbl_RAISE_CUSTOMER_ENTRIES();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_CHARGEOFF_cl arg0) {
