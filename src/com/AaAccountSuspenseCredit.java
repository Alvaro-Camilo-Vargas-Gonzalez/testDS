...
import com.temenos.t24.AA_ACCOUNT_SUSPENSE_CREDIT_cl;
...
public class AaAccountSuspenseCredit extends AA_ACCOUNT_SUSPENSE_CREDIT_cl {
    ...
    @Override
    protected int lbl_ProcessAuthroiseAction() {
        
        return super.lbl_ProcessAuthroiseAction();
    }
    ...
    @Override
    protected int lbl_ValidateMasterActivity() {
        
        return super.lbl_ValidateMasterActivity();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_SUSPENSE_CREDIT_cl arg0) {
