...
import com.temenos.t24.AA_ACTIVITY_RESTRICTION_OVERRIDES_cl;
...
public class AaActivityRestrictionOverrides extends AA_ACTIVITY_RESTRICTION_OVERRIDES_cl {
    ...
    @Override
    protected int lbl_CHECK_FOR_RESTRICT_LOG() {
        
        return super.lbl_CHECK_FOR_RESTRICT_LOG();
    }

    @Override
    protected int lbl_DetermineHvtProcess() {
        
        return super.lbl_DetermineHvtProcess();
    }
    ...
    @Override
    protected int lbl_ProcessOverride() {
        
        return super.lbl_ProcessOverride();
    }

    @Override
    protected int lbl_ValidateActivityId() {
        
        return super.lbl_ValidateActivityId();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_RESTRICTION_OVERRIDES_cl arg0) {
