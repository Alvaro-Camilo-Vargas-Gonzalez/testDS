...
import com.temenos.t24.AA_ACCOUNT_PAY_PARTICIPANT_cl;
...
public class AaAccountPayParticipant extends AA_ACCOUNT_PAY_PARTICIPANT_cl {
    ...
    @Override
    protected int lbl_GET_SIGN() {
        
        return super.lbl_GET_SIGN();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_PAY_PARTICIPANT_cl arg0) {
