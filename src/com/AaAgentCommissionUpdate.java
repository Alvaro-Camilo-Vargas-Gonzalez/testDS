...
import com.temenos.t24.AA_AGENT_COMMISSION_UPDATE_cl;
...
public class AaAgentCommissionUpdate extends AA_AGENT_COMMISSION_UPDATE_cl {
    ...
    @Override
    protected int lbl_CHECK_UPDATE_CUSTOMER() {
        
        return super.lbl_CHECK_UPDATE_CUSTOMER();
    }
    ...
    @Override
    protected int lbl_CYCLE_THE_SCHEDULED_ACTIVITY() {
        
        return super.lbl_CYCLE_THE_SCHEDULED_ACTIVITY();
    }

    @Override
    protected int lbl_DO_DELETE_AGENT() {
        
        return super.lbl_DO_DELETE_AGENT();
    }

    @Override
    protected int lbl_DO_UPDATE_AGENT() {
        
        return super.lbl_DO_UPDATE_AGENT();
    }

    @Override
    protected int lbl_DO_UPDATE_CUSTOMER_ARRANGEMENT() {
        
        return super.lbl_DO_UPDATE_CUSTOMER_ARRANGEMENT();
    }
    ...
    @Override
    protected int lbl_MERGE_OLD_AND_NEW_ARRANGEMENT() {
        
        return super.lbl_MERGE_OLD_AND_NEW_ARRANGEMENT();
    }
    ...
    @Override
    protected int lbl_SET_SCHEDULE_ACTIVITY() {
        
        return super.lbl_SET_SCHEDULE_ACTIVITY();
    }
    ...
    @Override
    protected int lbl_UPDATE_CUSTOMER_ARRANGEMENT() {
        
        return super.lbl_UPDATE_CUSTOMER_ARRANGEMENT();
    }

    @Override
    protected int lbl_UPDATE_PREVIOUS_SCHEDULED_ACTIVITY() {
        
        return super.lbl_UPDATE_PREVIOUS_SCHEDULED_ACTIVITY();
    }

    @Override
    protected int lbl_UPDATE_SCHEDULED_ACTIVITY() {
        
        return super.lbl_UPDATE_SCHEDULED_ACTIVITY();
    }
    ...
    @Override
    public void stack(AA_AGENT_COMMISSION_UPDATE_cl arg0) {
