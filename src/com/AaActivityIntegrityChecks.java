...
import com.temenos.t24.AA_ACTIVITY_INTEGRITY_CHECKS_cl;
...
public class AaActivityIntegrityChecks extends AA_ACTIVITY_INTEGRITY_CHECKS_cl {
    ...
    @Override
    protected int lbl_checkerror() {
        
        return super.lbl_checkerror();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_INTEGRITY_CHECKS_cl arg0) {
