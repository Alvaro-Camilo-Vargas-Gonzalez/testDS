...
import com.temenos.t24.AA_ACTIVITY_MESSAGING_UPDATE_cl;
...
public class AaActivityMessagingUpdate extends AA_ACTIVITY_MESSAGING_UPDATE_cl {
    ...
    @Override
    protected int lbl_GET_SCHEDULED_ACTIVITY_DATE() {
        
        return super.lbl_GET_SCHEDULED_ACTIVITY_DATE();
    }
    ...
    @Override
    protected int lbl_SCHEDULE_PRE_NOTICE_ACTIVITY() {
        
        return super.lbl_SCHEDULE_PRE_NOTICE_ACTIVITY();
    }
    ...
    @Override
    protected int lbl_VALIDATE_PRE_NOTICE_DATE() {
        
        return super.lbl_VALIDATE_PRE_NOTICE_DATE();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_MESSAGING_UPDATE_cl arg0) {
