...
import com.temenos.t24.AA_ACCOUNT_CHECK_BACKDATED_cl;
...
public class AaAccountCheckBackdated extends AA_ACCOUNT_CHECK_BACKDATED_cl {
    ...
    @Override
    protected int lbl_GET_ARR_DETAILS() {
        
        return super.lbl_GET_ARR_DETAILS();
    }
    ...
    @Override
    protected int lbl_UPDATE_ARR_FIELDS_REC() {
        
        return super.lbl_UPDATE_ARR_FIELDS_REC();
    }

    @Override
    protected int lbl_UPDATE_SHORT_TITLE() {
        
        return super.lbl_UPDATE_SHORT_TITLE();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_CHECK_BACKDATED_cl arg0) {
