...
import com.temenos.t24.AA_ADVICE_TYPE_UPDATE_cl;
import com.temenos.t24.component_AA_ProductManagement_24_cl;
import com.temenos.t24.component_AF_Advice_14_cl;
...
public class AaAdviceTypeUpdate extends AA_ADVICE_TYPE_UPDATE_cl {
    ...
    @Override
    public component_AF_Advice_14_cl getAF_Advice() {
        
        return super.getAF_Advice();
    }
    ...
    @Override
    protected int lbl_CREATE_ARTEFACTS() {
        
        return super.lbl_CREATE_ARTEFACTS();
    }

    @Override
    protected int lbl_DO_WRITE() {
        
        return super.lbl_DO_WRITE();
    }
    ...
    @Override
    protected int lbl_UPDATE_FILE() {
        
        return super.lbl_UPDATE_FILE();
    }
    ...
    @Override
    public void stack(AA_ADVICE_TYPE_UPDATE_cl arg0) {
