...
import com.temenos.t24.AA_APPLICATION_IMAGE_HANDOFF_cl;
...
public class AaApplicationImageHandoff extends AA_APPLICATION_IMAGE_HANDOFF_cl {
    ...
    @Override
    protected int lbl_CheckForAuthProcess() {
        
        return super.lbl_CheckForAuthProcess();
    }

    @Override
    protected int lbl_CheckReqdInfo() {
        
        return super.lbl_CheckReqdInfo();
    }

    @Override
    protected int lbl_GetImageRequestReference() {
        
        return super.lbl_GetImageRequestReference();
    }

    @Override
    protected int lbl_GetPreImage() {
        
        return super.lbl_GetPreImage();
    }

    @Override
    protected int lbl_HandleException() {
        
        return super.lbl_HandleException();
    }
    ...
    @Override
    protected int lbl_StoreImage() {
        
        return super.lbl_StoreImage();
    }
    ...
    @Override
    public void stack(AA_APPLICATION_IMAGE_HANDOFF_cl arg0) {
