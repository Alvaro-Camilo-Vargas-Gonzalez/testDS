...
import com.temenos.t24.AA_ACTIVITY_RESTRICTION_ALTERNATE_cl;
...
public class AaActivityRestrictionAlternate extends AA_ACTIVITY_RESTRICTION_ALTERNATE_cl {
    ...
    @Override
    protected int lbl_CHECK_ALTERNATE_INTEREST() {
        
        return super.lbl_CHECK_ALTERNATE_INTEREST();
    }
    ...
    @Override
    protected int lbl_SUPRESS_ACCRUAL() {
        
        return super.lbl_SUPRESS_ACCRUAL();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_RESTRICTION_ALTERNATE_cl arg0) {
