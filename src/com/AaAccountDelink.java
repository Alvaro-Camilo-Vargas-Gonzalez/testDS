...
import com.temenos.t24.AA_ACCOUNT_DELINK_cl;
...
public class AaAccountDelink extends AA_ACCOUNT_DELINK_cl {
    ...
    @Override
    protected int lbl_ProcessAuthRevAction() {

        return super.lbl_ProcessAuthRevAction();
    }
    ...
    @Override
    protected int lbl_ProcessDeleteReverseAction() {

        return super.lbl_ProcessDeleteReverseAction();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_DELINK_cl arg0) {
