...
import com.temenos.t24.AA_ACCRUE_INTEREST_DETAILS_cl;
...
public class AaAccrueInterestDetails extends AA_ACCRUE_INTEREST_DETAILS_cl {
    ...
    @Override
    protected int lbl_ADJUST_ACCRUALS() {
        
        return super.lbl_ADJUST_ACCRUALS();
    }
    ...
    @Override
    protected int lbl_BUILD_START_INT_PERIOD() {
        
        return super.lbl_BUILD_START_INT_PERIOD();
    }
    ...
    @Override
    protected int lbl_DO_ACCRUE_BY_BILL() {
        
        return super.lbl_DO_ACCRUE_BY_BILL();
    }
    ...
    @Override
    protected int lbl_GET_CURRENT_PERIOD() {
        
        return super.lbl_GET_CURRENT_PERIOD();
    }
    ...
    @Override
    public void stack(AA_ACCRUE_INTEREST_DETAILS_cl arg0) {
