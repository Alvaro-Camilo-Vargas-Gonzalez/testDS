...
import com.temenos.t24.AA_ACTION_VALIDATE_cl;
import com.temenos.t24.component_AA_ActivityControl_22_cl;
import com.temenos.t24.component_AA_ActivityRestriction_26_cl;
...
public class AaActionValidate extends AA_ACTION_VALIDATE_cl {
    ...
    @Override
    public component_AA_ActivityControl_22_cl getAA_ActivityControl() {
        
        return super.getAA_ActivityControl();
    }

    @Override
    public component_AA_ActivityRestriction_26_cl getAA_ActivityRestriction() {
        
        return super.getAA_ActivityRestriction();
    }
    ...
    @Override
    protected int lbl_AuthValidate() {
        
        return super.lbl_AuthValidate();
    }

    @Override
    protected int lbl_GetActivityClassRec() {
        
        return super.lbl_GetActivityClassRec();
    }
    ...
    @Override
    protected int lbl_ProcessValidate() {
        
        return super.lbl_ProcessValidate();
    }

    @Override
    protected int lbl_RealValidate() {
        
        return super.lbl_RealValidate();
    }

    @Override
    protected int lbl_ValidateAction() {
        
        return super.lbl_ValidateAction();
    }

    @Override
    protected int lbl_ValidateActivity() {
        
        return super.lbl_ValidateActivity();
    }

    @Override
    protected int lbl_ValidateProduct() {
        
        return super.lbl_ValidateProduct();
    }
    ...
    @Override
    public void stack(AA_ACTION_VALIDATE_cl arg0) {
