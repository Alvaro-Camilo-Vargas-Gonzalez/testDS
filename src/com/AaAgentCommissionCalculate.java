...
import com.temenos.t24.AA_AGENT_COMMISSION_CALCULATE_cl;
...
public class AaAgentCommissionCalculate extends AA_AGENT_COMMISSION_CALCULATE_cl {
    ...
    @Override
    protected int lbl_PROCESS_COMMISSION_FOR_AGENT() {
        
        return super.lbl_PROCESS_COMMISSION_FOR_AGENT();
    }
    ...
    @Override
    protected int lbl_WRITE_LIST_FILE() {
        
        return super.lbl_WRITE_LIST_FILE();
    }
    ...
    @Override
    public void stack(AA_AGENT_COMMISSION_CALCULATE_cl arg0) {
