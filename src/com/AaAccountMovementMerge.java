...
import com.temenos.t24.AA_ACCOUNT_MOVEMENT_MERGE_cl;
...
public class AaAccountMovementMerge extends AA_ACCOUNT_MOVEMENT_MERGE_cl {
    ...
    @Override
    protected int lbl_FieldPositions() {
        
        return super.lbl_FieldPositions();
    }

    @Override
    protected int lbl_GetAccountMovementRecord() {
        
        return super.lbl_GetAccountMovementRecord();
    }
    ...
    @Override
    protected int lbl_InitiateMergingProcess() {
        
        return super.lbl_InitiateMergingProcess();
    }

    @Override
    protected int lbl_LoadProcessData() {
        
        return super.lbl_LoadProcessData();
    }
    ...
    @Override
    protected int lbl_ProcessMergeActivity() {
        
        return super.lbl_ProcessMergeActivity();
    }

    @Override
    protected int lbl_ProcessMergeBalance() {
        
        return super.lbl_ProcessMergeBalance();
    }

    @Override
    protected int lbl_RemoveNullAssociation() {
        
        return super.lbl_RemoveNullAssociation();
    }

    @Override
    protected int lbl_WriteAccountMovementRecord() {
        
        return super.lbl_WriteAccountMovementRecord();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_MOVEMENT_MERGE_cl arg0) {
