...
import com.temenos.t24.AA_ACTIVITY_CHARGES_CALCULATE_GUARD_cl;
...
public class AaActivityChargesCalculateGuard extends AA_ACTIVITY_CHARGES_CALCULATE_GUARD_cl {
    ...
    @Override
    protected int lbl_CheckChargeRequired() {
        
        return super.lbl_CheckChargeRequired();
    }
    ...
    @Override
    protected int lbl_GetChargeSetup() {
        
        return super.lbl_GetChargeSetup();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_CHARGES_CALCULATE_GUARD_cl arg0) {
