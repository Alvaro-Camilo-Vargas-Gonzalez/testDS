...
import com.temenos.t24.AA_ACTIVITY_MESSAGING_SEND_MESSAGE_GUARD_cl;
...
public class AaActivityMessagingSendMessageGuard extends AA_ACTIVITY_MESSAGING_SEND_MESSAGE_GUARD_cl {
    ...
    @Override
    protected int lbl_CheckMessageRequired() {
        
        return super.lbl_CheckMessageRequired();
    }
    ...
    @Override
    protected int lbl_GetMessageSetup() {
        
        return super.lbl_GetMessageSetup();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_MESSAGING_SEND_MESSAGE_GUARD_cl arg0) {
