...
import com.temenos.t24.AA_ACCOUNT_RECEIVE_cl;
...
public class AaAccountReceive extends AA_ACCOUNT_RECEIVE_cl {
    ...
    @Override
    protected int lbl_BUILD_ACCOUNTING_EVENTS() {
        
        return super.lbl_BUILD_ACCOUNTING_EVENTS();
    }
    ...
    @Override
    protected int lbl_CHECK_ARR_STATUS() {
        
        return super.lbl_CHECK_ARR_STATUS();
    }

    @Override
    protected int lbl_CHECK_TERM_AMOUNT_UPDATE() {
        
        return super.lbl_CHECK_TERM_AMOUNT_UPDATE();
    }

    @Override
    protected int lbl_GET_ACTIVITY_BALANCES() {
        
        return super.lbl_GET_ACTIVITY_BALANCES();
    }

    @Override
    protected int lbl_GET_ACTUAL_ACCOUNTING_DATE() {
        
        return super.lbl_GET_ACTUAL_ACCOUNTING_DATE();
    }
    ...
    @Override
    protected int lbl_GET_REQUIRED_DETAILS() {
        
        return super.lbl_GET_REQUIRED_DETAILS();
    }
    ...
    @Override
    protected int lbl_PROCESS_ACTIVITY_BALANCES() {
        
        return super.lbl_PROCESS_ACTIVITY_BALANCES();
    }
    ...
    @Override
    protected int lbl_PROCESS_BILLS() {
        
        return super.lbl_PROCESS_BILLS();
    }
    ...
    @Override
    protected int lbl_PROCESS_REVERSE_DELETE_ACTION() {
        
        return super.lbl_PROCESS_REVERSE_DELETE_ACTION();
    }
    ...
    @Override
    protected int lbl_UPDATE_AA_SCHEDULED_ACTIVITY() {
        
        return super.lbl_UPDATE_AA_SCHEDULED_ACTIVITY();
    }
    ...
    @Override
    protected int lbl_UPDATE_TERM_AMOUNT() {
        
        return super.lbl_UPDATE_TERM_AMOUNT();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_RECEIVE_cl arg0) {
