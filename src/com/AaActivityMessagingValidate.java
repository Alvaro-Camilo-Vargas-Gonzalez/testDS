...
import com.temenos.t24.AA_ACTIVITY_MESSAGING_VALIDATE_cl;
...
public class AaActivityMessagingValidate extends AA_ACTIVITY_MESSAGING_VALIDATE_cl {
    ...
    @Override
    protected int lbl_DUP_CHECK() {
        
        return super.lbl_DUP_CHECK();
    }

    @Override
    protected int lbl_GET_ACTIVITY_CLASS() {
        
        return super.lbl_GET_ACTIVITY_CLASS();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_MESSAGING_VALIDATE_cl arg0) {
