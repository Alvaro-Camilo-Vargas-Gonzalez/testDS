...
import com.temenos.t24.AA_ACTIVITY_HISTORY_DETAILS_cl;
import com.temenos.t24.component_AA_Framework_17_cl;
import com.temenos.t24.component_USCORE_Foundation_18_cl;
import com.temenos.tafj.common.jSession;
import com.temenos.tafj.common.jVar;

public class AaActivityHistoryDetails extends AA_ACTIVITY_HISTORY_DETAILS_cl {
    ...
    @Override
    public component_USCORE_Foundation_18_cl getUSCORE_Foundation() {
        
        return super.getUSCORE_Foundation();
    }
    ...
    @Override
    protected int lbl_GET_HISTORY_RECORD() {
        
        return super.lbl_GET_HISTORY_RECORD();
    }

    @Override
    protected int lbl_INTITIALISE() {
        
        return super.lbl_INTITIALISE();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_HISTORY_DETAILS_cl arg0) {
