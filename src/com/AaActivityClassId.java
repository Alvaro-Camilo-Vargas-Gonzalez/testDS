...
import com.temenos.t24.AA_ACTIVITY_CLASS_ID_cl;
...
public class AaActivityClassId extends AA_ACTIVITY_CLASS_ID_cl {
    ...
    @Override
    protected int lbl_CHECK_ID() {
        
        return super.lbl_CHECK_ID();
    }

    @Override
    protected int lbl_EXTRACT_ELEMENTS() {
        
        return super.lbl_EXTRACT_ELEMENTS();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_CLASS_ID_cl arg0) {
