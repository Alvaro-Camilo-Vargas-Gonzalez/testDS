...
import com.temenos.t24.AA_ACCOUNT_FORCE_CLOSE_cl;
...
public class AaAccountForceClose extends AA_ACCOUNT_FORCE_CLOSE_cl {
    ...
    @Override
    protected int lbl_BuildAccountingEntries() {
        
        return super.lbl_BuildAccountingEntries();
    }
    ...
    @Override
    protected int lbl_ProcessLinkAccount() {
        
        return super.lbl_ProcessLinkAccount();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_FORCE_CLOSE_cl arg0) {
