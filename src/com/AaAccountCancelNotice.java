...
import com.temenos.t24.AA_ACCOUNT_CANCEL_NOTICE_cl;
...
public class AaAccountCancelNotice extends AA_ACCOUNT_CANCEL_NOTICE_cl {
    ...
    @Override
    protected int lbl_GetAvailableAmount() {
        
        return super.lbl_GetAvailableAmount();
    }
    ...
    @Override
    protected int lbl_GetNoticeWithdrawalRecord() {
        
        return super.lbl_GetNoticeWithdrawalRecord();
    }
    ...
    @Override
    protected int lbl_RaiseAccountingEntry() {
        
        return super.lbl_RaiseAccountingEntry();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_CANCEL_NOTICE_cl arg0) {
