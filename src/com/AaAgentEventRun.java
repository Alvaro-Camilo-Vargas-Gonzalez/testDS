...
import com.temenos.t24.AA_AGENT_EVENT_RUN_cl;
...
public class AaAgentEventRun extends AA_AGENT_EVENT_RUN_cl {
    ...
    @Override
    protected int lbl_DO_PROCESSING() {
        
        return super.lbl_DO_PROCESSING();
    }
    ...
    @Override
    protected int lbl_WriteActivationFile() {
        
        return super.lbl_WriteActivationFile();
    }
    ...
    @Override
    public void stack(AA_AGENT_EVENT_RUN_cl arg0) {
