...
import com.temenos.t24.AA_ALLOCATE_UNIQUE_TIME_cl;
...
public class AaAllocateUniqueTime extends AA_ALLOCATE_UNIQUE_TIME_cl {
    ...
    @Override
    protected int lbl_FORMAT_TIME() {
        
        return super.lbl_FORMAT_TIME();
    }
    ...
    @Override
    protected int lbl_REFRESH_TIME_SEQ() {
        
        return super.lbl_REFRESH_TIME_SEQ();
    }

    @Override
    protected int lbl_SET_TIME_SEQ() {
        
        return super.lbl_SET_TIME_SEQ();
    }
    ...
    @Override
    public void stack(AA_ALLOCATE_UNIQUE_TIME_cl arg0) {
