...
import com.temenos.t24.AA_APPLY_OR_WAIVE_BILL_TYPE_cl;
...
public class AaApplyOrWaveBillType extends AA_APPLY_OR_WAIVE_BILL_TYPE_cl {
    ...
    @Override
    protected int lbl_CheckBillType() {
        
        return super.lbl_CheckBillType();
    }
    ...
    @Override
    protected int lbl_ProcessEvaluation() {
        
        return super.lbl_ProcessEvaluation();
    }
    ...
    @Override
    public void stack(AA_APPLY_OR_WAIVE_BILL_TYPE_cl arg0) {
