...
import com.temenos.t24.AA_ARR_SAVINGS_TARGET_cl;
import com.temenos.t24.component_AS_SavingsTarget_20_cl;
import com.temenos.tafj.common.jSession;
import com.temenos.tafj.common.jVar;

public class AaArrSavingsTarget extends AA_ARR_SAVINGS_TARGET_cl {
    ...
    @Override
    public int INSERT__I__METHODS_AND_PROPERTIES() {
        
        return super.INSERT__I__METHODS_AND_PROPERTIES();
    }
    ...
    @Override
    public component_AS_SavingsTarget_20_cl getAS_SavingsTarget() {
        
        return super.getAS_SavingsTarget();
    }
    ...
    @Override
    public void stack(AA_ARR_SAVINGS_TARGET_cl arg0) {
