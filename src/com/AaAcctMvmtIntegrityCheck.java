...
import com.temenos.t24.AA_ACCT_MVMT_INTEGRITY_CHECK_cl;
...
public class AaAcctMvmtIntegrityCheck extends AA_ACCT_MVMT_INTEGRITY_CHECK_cl {
    ...
    @Override
    protected int lbl_CheckRecordStatus() {
        
        return super.lbl_CheckRecordStatus();
    }
    ...
    @Override
    protected int lbl_getAcctMovement() {
        
        return super.lbl_getAcctMovement();
    }
    ...
    @Override
    public void stack(AA_ACCT_MVMT_INTEGRITY_CHECK_cl arg0) {
