...
import com.temenos.t24.AA_ADHOC_IMAGE_HANDOFF_cl;
...
import com.temenos.t24.component_AF_ClassFramework_21_cl;
...
public class AaAdhocImageHandoff extends AA_ADHOC_IMAGE_HANDOFF_cl {
    ...
    @Override
    public component_AF_ClassFramework_21_cl getAF_ClassFramework() {
        
        return super.getAF_ClassFramework();
    }
    ...
    @Override
    protected int lbl_CheckCaptureRequired() {
        
        return super.lbl_CheckCaptureRequired();
    }

    @Override
    protected int lbl_CheckRequiredValues() {
        
        return super.lbl_CheckRequiredValues();
    }

    @Override
    protected int lbl_GetApplicationRecord() {
        
        return super.lbl_GetApplicationRecord();
    }

    @Override
    protected int lbl_HandOffRecord() {
        
        return super.lbl_HandOffRecord();
    }
    ...
    @Override
    protected int lbl_MaserApplicationRecord() {
        
        return super.lbl_MaserApplicationRecord();
    }
    ...
    @Override
    public void stack(AA_ADHOC_IMAGE_HANDOFF_cl arg0) {
