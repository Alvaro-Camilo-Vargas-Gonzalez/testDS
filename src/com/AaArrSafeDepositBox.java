...
import com.temenos.t24.AA_ARR_SAFE_DEPOSIT_BOX_cl;
import com.temenos.t24.component_AA_Framework_17_cl;
import com.temenos.t24.component_AA_SafeDepositBox_20_cl;
...
public class AaArrSafeDepositBox extends AA_ARR_SAFE_DEPOSIT_BOX_cl {
    ...
    @Override
    public component_AA_SafeDepositBox_20_cl getAA_SafeDepositBox() {
        
        return super.getAA_SafeDepositBox();
    }
    ...
    @Override
    public void stack(AA_ARR_SAFE_DEPOSIT_BOX_cl arg0) {
