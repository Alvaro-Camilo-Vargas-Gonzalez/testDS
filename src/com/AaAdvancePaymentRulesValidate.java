...
import com.temenos.t24.AA_ADVANCE_PAYMENT_RULES_VALIDATE_cl;
...
public class AaAdvancePaymentRulesValidate extends AA_ADVANCE_PAYMENT_RULES_VALIDATE_cl {
    ...
    @Override
    protected int lbl_ADVANCE_RULE_VALIDATION() {
        
        return super.lbl_ADVANCE_RULE_VALIDATION();
    }

    @Override
    protected int lbl_BALANCE_TYPE_VALIDATION() {
        
        return super.lbl_BALANCE_TYPE_VALIDATION();
    }
    ...
    @Override
    public void stack(AA_ADVANCE_PAYMENT_RULES_VALIDATE_cl arg0) {
