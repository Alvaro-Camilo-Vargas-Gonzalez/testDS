...
import com.temenos.t24.AA_APPLY_PERIODIC_CHARGES_PRICING_cl;
...
public class AaApplyPeriodicChargesPricing extends AA_APPLY_PERIODIC_CHARGES_PRICING_cl {
    ...
    @Override
    protected int lbl_APPLY_PRICING_CALCULATION() {
        
        return super.lbl_APPLY_PRICING_CALCULATION();
    }

    @Override
    protected int lbl_CALCULATE_BY_ADJ_AMOUNT() {
        
        return super.lbl_CALCULATE_BY_ADJ_AMOUNT();
    }

    @Override
    protected int lbl_CALCULATE_BY_PERCENTAGE() {
        
        return super.lbl_CALCULATE_BY_PERCENTAGE();
    }
    ...
    @Override
    public void stack(AA_APPLY_PERIODIC_CHARGES_PRICING_cl arg0) {
