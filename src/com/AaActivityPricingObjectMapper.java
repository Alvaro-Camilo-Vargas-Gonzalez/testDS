...
import com.temenos.t24.AA_ACTIVITY_PRICING_OBJECT_MAPPER_cl;
import com.temenos.t24.component_AA_EventStructures_22_cl;
import com.temenos.tafj.common.jSession;
import com.temenos.tafj.common.jVar;

public class AaActivityPricingObjectMapper extends AA_ACTIVITY_PRICING_OBJECT_MAPPER_cl {
    ...
    @Override
    public component_AA_EventStructures_22_cl getAA_EventStructures() {
        
        return super.getAA_EventStructures();
    }
    ...
    @Override
    protected int lbl_DoProcess() {
        
        return super.lbl_DoProcess();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_PRICING_OBJECT_MAPPER_cl arg0) {
