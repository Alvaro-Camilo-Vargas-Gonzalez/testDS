...
import com.temenos.t24.AA_ACCOUNT_DISBURSE_PARTICIPANT_cl;
...
public class AaAccountDisburseParticipant extends AA_ACCOUNT_DISBURSE_PARTICIPANT_cl {
    ...
    @Override
    protected int lbl_CALCULATE_PARTICIPANT_AMT() {
        
        return super.lbl_CALCULATE_PARTICIPANT_AMT();
    }

    @Override
    protected int lbl_CHECK_RESTRICTIONS() {
        
        return super.lbl_CHECK_RESTRICTIONS();
    }

    @Override
    protected int lbl_GET_AMOUNT_AND_DATE() {
        
        return super.lbl_GET_AMOUNT_AND_DATE();
    }
    ...
    @Override
    protected int lbl_GET_MASTER_ACTIVITY_REF() {
        
        return super.lbl_GET_MASTER_ACTIVITY_REF();
    }
    ...
    @Override
    protected int lbl_GET_PARTICIPANT_DISBURSEMENT_BILLS() {
        
        return super.lbl_GET_PARTICIPANT_DISBURSEMENT_BILLS();
    }
    ...
    @Override
    protected int lbl_GET_ROLLOVER_BOOK_BILL_AMOUNT() {
        
        return super.lbl_GET_ROLLOVER_BOOK_BILL_AMOUNT();
    }

    @Override
    protected int lbl_GET_ROLLOVER_DISBURSE_AMOUNT() {
        
        return super.lbl_GET_ROLLOVER_DISBURSE_AMOUNT();
    }

    @Override
    protected int lbl_GET_SOURCE_BOOK_PROCESS_AMOUNT() {
        
        return super.lbl_GET_SOURCE_BOOK_PROCESS_AMOUNT();
    }

    @Override
    protected int lbl_GET_SPLITS_MERGES_RECORD() {
        
        return super.lbl_GET_SPLITS_MERGES_RECORD();
    }
    ...
    @Override
    protected int lbl_PROCESS_ACT_BALANCES() {
        
        return super.lbl_PROCESS_ACT_BALANCES();
    }
    ...
    @Override
    protected int lbl_ProcessExchangeRate() {
        
        return super.lbl_ProcessExchangeRate();
    }

    @Override
    protected int lbl_RAISE_ROUDING_ENTRIES() {
        
        return super.lbl_RAISE_ROUDING_ENTRIES();
    }

    @Override
    protected int lbl_RAISE_SUSP_ENTRY() {
        
        return super.lbl_RAISE_SUSP_ENTRY();
    }
    ...
    @Override
    protected int lbl_WRITE_ACTIVITY_BALANCES() {
        
        return super.lbl_WRITE_ACTIVITY_BALANCES();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_DISBURSE_PARTICIPANT_cl arg0) {
