...
import com.temenos.t24.AA_ACTIVITY_VALIDATE_cl;
...
import com.temenos.t24.component_EB_MicroService_19_cl;
...
public class AaActivityValidate extends AA_ACTIVITY_VALIDATE_cl {
    ...
    @Override
    public component_EB_MicroService_19_cl getEB_MicroService() {
        
        return super.getEB_MicroService();
    }
    ...
    @Override
    protected int lbl_AUTH_VALIDATE() {
        
        return super.lbl_AUTH_VALIDATE();
    }

    @Override
    protected int lbl_CHECK_TRANSACTION_ACTIVITY() {
        
        return super.lbl_CHECK_TRANSACTION_ACTIVITY();
    }

    @Override
    protected int lbl_COMPARE_PREVIOUS_RECORD() {
        
        return super.lbl_COMPARE_PREVIOUS_RECORD();
    }

    @Override
    protected int lbl_DELETE_VALIDATE() {
        
        return super.lbl_DELETE_VALIDATE();
    }
    ...
    @Override
    protected int lbl_REAL_VALIDATE() {
        
        return super.lbl_REAL_VALIDATE();
    }

    @Override
    protected int lbl_REVERSE_VALIDATE() {
        
        return super.lbl_REVERSE_VALIDATE();
    }

    @Override
    protected int lbl_VALIDATE_EVENT() {
        
        return super.lbl_VALIDATE_EVENT();
    }

    @Override
    protected int lbl_VALIDATE_RESTRICT_LOG() {
        
        return super.lbl_VALIDATE_RESTRICT_LOG();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_VALIDATE_cl arg0) {
