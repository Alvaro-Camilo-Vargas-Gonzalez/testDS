...
import com.temenos.t24.AA_ACCOUNT_CANCEL_LENDING_cl;
...
public class AaAccountCancelLending extends AA_ACCOUNT_CANCEL_LENDING_cl {
    ...
    @Override
    protected int lbl_ADJUST_AVL_BALANCE() {
        
        return super.lbl_ADJUST_AVL_BALANCE();
    }
    ...
    @Override
    protected int lbl_GET_AVL_BILL() {
        
        return super.lbl_GET_AVL_BILL();
    }
    ...
    @Override
    protected int lbl_GET_BILL_RECORD() {
        
        return super.lbl_GET_BILL_RECORD();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_CANCEL_LENDING_cl arg0) {
