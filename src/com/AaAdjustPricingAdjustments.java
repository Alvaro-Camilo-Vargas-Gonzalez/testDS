...
import com.temenos.t24.AA_ADJUST_PRICING_ADJUSTMENTS_cl;
...
import com.temenos.t24.component_AA_PricingAdjustments_25_cl;
...
public class AaAdjustPricingAdjustments extends AA_ADJUST_PRICING_ADJUSTMENTS_cl {
    ...
    @Override
    public component_AA_PricingAdjustments_25_cl getAA_PricingAdjustments() {
        
        return super.getAA_PricingAdjustments();
    }
    ...
    @Override
    protected int lbl_FormChargeRecord() {
        
        return super.lbl_FormChargeRecord();
    }

    @Override
    protected int lbl_FormInterestRecord() {
        
        return super.lbl_FormInterestRecord();
    }

    @Override
    protected int lbl_FormPeriodicChargesRecord() {
        
        return super.lbl_FormPeriodicChargesRecord();
    }
    ...
    @Override
    protected int lbl_MergeInterestWithContextValues() {
        
        return super.lbl_MergeInterestWithContextValues();
    }
    ...
    @Override
    public void stack(AA_ADJUST_PRICING_ADJUSTMENTS_cl arg0) {
