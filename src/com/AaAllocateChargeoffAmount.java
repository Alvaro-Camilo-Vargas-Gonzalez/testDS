...
import com.temenos.t24.AA_ALLOCATE_CHARGEOFF_AMOUNT_cl;
...
public class AaAllocateChargeoffAmount extends AA_ALLOCATE_CHARGEOFF_AMOUNT_cl {
    ...
    @Override
    protected int lbl_ALLOCATE_BILL_CHARGEOFF_AMOUNT() {
        
        return super.lbl_ALLOCATE_BILL_CHARGEOFF_AMOUNT();
    }

    @Override
    protected int lbl_ALLOCATE_CURRENT_CHARGEOFF_AMOUNT() {
        
        return super.lbl_ALLOCATE_CURRENT_CHARGEOFF_AMOUNT();
    }
    ...
    @Override
    protected int lbl_APPLY_CHARGEOFF_RULES() {
        
        return super.lbl_APPLY_CHARGEOFF_RULES();
    }
    ...
    @Override
    protected int lbl_INSERT_CHARGEOFF_DETAILS() {
        
        return super.lbl_INSERT_CHARGEOFF_DETAILS();
    }

    @Override
    protected int lbl_PROCESS_CHARGEOFF_AMOUNT() {
        
        return super.lbl_PROCESS_CHARGEOFF_AMOUNT();
    }

    @Override
    protected int lbl_UPDATE_CHARGEOFF_AMOUNT() {
        
        return super.lbl_UPDATE_CHARGEOFF_AMOUNT();
    }
    ...
    @Override
    public void stack(AA_ALLOCATE_CHARGEOFF_AMOUNT_cl arg0) {
