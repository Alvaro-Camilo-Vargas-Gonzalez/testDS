...
import com.temenos.t24.AA_ACCOUNT_DR_MOVEMENT_cl;
...
public class AaAccountDrMovement extends AA_ACCOUNT_DR_MOVEMENT_cl {
    ...
    @Override
    protected int lbl_PROCESS_ACCOUNT_DEBIT() {
        
        return super.lbl_PROCESS_ACCOUNT_DEBIT();
    }
    ...
    @Override
    protected int lbl_PROCESS_LINK_ACCOUNT_CREDIT() {
        
        return super.lbl_PROCESS_LINK_ACCOUNT_CREDIT();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_DR_MOVEMENT_cl arg0) {
