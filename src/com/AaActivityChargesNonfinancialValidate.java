...
import com.temenos.t24.AA_ACTIVITY_CHARGES_NONFINANCIAL_VALIDATE_cl;
...
public class AaActivityChargesNonfinancialValidate extends AA_ACTIVITY_CHARGES_NONFINANCIAL_VALIDATE_cl {
    ...
    @Override
    protected int lbl_ValidateChargeAutoSettle() {
        
        return super.lbl_ValidateChargeAutoSettle();
    }

    @Override
    protected int lbl_ValidateSettleActivity() {
        
        return super.lbl_ValidateSettleActivity();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_CHARGES_NONFINANCIAL_VALIDATE_cl arg0) {
