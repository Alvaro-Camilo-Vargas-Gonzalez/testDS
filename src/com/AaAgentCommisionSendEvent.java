...
import com.temenos.t24.AA_AGENT_COMMISSION_SEND_EVENT_cl;
...
public class AaAgentCommisionSendEvent extends AA_AGENT_COMMISSION_SEND_EVENT_cl {
    ...
    @Override
    protected int lbl_CHECK_UPDATE_AGENT_EVENT() {
        
        return super.lbl_CHECK_UPDATE_AGENT_EVENT();
    }

    @Override
    protected int lbl_DO_UPDATE_AGENT_EVENT() {
        
        return super.lbl_DO_UPDATE_AGENT_EVENT();
    }
    ...
    @Override
    protected int lbl_UPDATE_AGENT_EVENT() {
        
        return super.lbl_UPDATE_AGENT_EVENT();
    }
    ...
    @Override
    public void stack(AA_AGENT_COMMISSION_SEND_EVENT_cl arg0) {
