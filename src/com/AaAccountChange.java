...
import com.temenos.t24.AA_ACCOUNT_CHANGE_cl;
...
public class AaAccountChange extends AA_ACCOUNT_CHANGE_cl {
    ...
    @Override
    protected int lbl_CHECK_FORWARD_FLAG() {
        
        return super.lbl_CHECK_FORWARD_FLAG();
    }
    ...
    @Override
    protected int lbl_GET_CHANGED_PROPERTY_CLASS() {
        
        return super.lbl_GET_CHANGED_PROPERTY_CLASS();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_CHANGE_cl arg0) {
