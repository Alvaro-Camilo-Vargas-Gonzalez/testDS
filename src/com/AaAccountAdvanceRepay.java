...
import com.temenos.t24.AA_ACCOUNT_ADVANCE_REPAY_cl;
...
public class AaAccountAdvanceRepay extends AA_ACCOUNT_ADVANCE_REPAY_cl {
    ...
    @Override
    protected int lbl_CHECK_CREDIT_INTEREST() {
        
        return super.lbl_CHECK_CREDIT_INTEREST();
    }

    @Override
    protected int lbl_GET_ADVANCE_BALANCE_AMOUNT() {
        
        return super.lbl_GET_ADVANCE_BALANCE_AMOUNT();
    }

    @Override
    protected int lbl_GET_ADVANCE_BALANCE_NAME() {
        
        return super.lbl_GET_ADVANCE_BALANCE_NAME();
    }
    ...
    @Override
    protected int lbl_GET_PAYOFF_BILL() {
        
        return super.lbl_GET_PAYOFF_BILL();
    }

    @Override
    protected int lbl_GET_UNC_BILL_AMOUNT() {
        
        return super.lbl_GET_UNC_BILL_AMOUNT();
    }
    ...
    @Override
    protected int lbl_PROCESS_PO_BALANCES() {
        
        return super.lbl_PROCESS_PO_BALANCES();
    }
    ...
    @Override
    public void stack(AA_ACCOUNT_ADVANCE_REPAY_cl arg0) {
