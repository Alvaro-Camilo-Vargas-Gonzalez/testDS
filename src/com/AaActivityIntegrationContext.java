...
import com.temenos.t24.AA_ACTIVITY_INTEGRATION_CONTEXT_cl;
...
public class AaActivityIntegrationContext extends AA_ACTIVITY_INTEGRATION_CONTEXT_cl {
    ...
    @Override
    protected int lbl_DetermineActivityContext() {
        
        return super.lbl_DetermineActivityContext();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_INTEGRATION_CONTEXT_cl arg0) {
