...
import com.temenos.t24.AA_AMS_RETRIEVER_METHOD_cl;
import com.temenos.t24.component_AA_Framework_17_cl;
import com.temenos.t24.component_BE_AlertProcessing_22_cl;
...
public class AaAmsRetrieverMethod extends AA_AMS_RETRIEVER_METHOD_cl {
    ...
    @Override
    public component_BE_AlertProcessing_22_cl getBE_AlertProcessing() {
        
        return super.getBE_AlertProcessing();
    }
    ...
    @Override
    protected int lbl_CallAPI() {
        
        return super.lbl_CallAPI();
    }

    @Override
    protected int lbl_ExtractBusinessObject() {
        
        return super.lbl_ExtractBusinessObject();
    }

    @Override
    protected int lbl_ExtractJsonValues() {
        
        return super.lbl_ExtractJsonValues();
    }

    @Override
    protected int lbl_GetJsonValues() {
        
        return super.lbl_GetJsonValues();
    }
    ...
    @Override
    public void stack(AA_AMS_RETRIEVER_METHOD_cl arg0) {
