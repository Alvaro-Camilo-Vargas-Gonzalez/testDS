...
import com.temenos.t24.AA_ADJUST_INTEREST_RATE_cl;
...
public class AaAdjustInterestRate extends AA_ADJUST_INTEREST_RATE_cl {
    ...
    @Override
    protected int lbl_AppendRecords() {
        
        return super.lbl_AppendRecords();
    }

    @Override
    protected int lbl_DetermineAdjustmentType() {
        
        return super.lbl_DetermineAdjustmentType();
    }

    @Override
    protected int lbl_FullAdjustment() {
        
        return super.lbl_FullAdjustment();
    }
    ...
    @Override
    protected int lbl_PartialAdjustment() {
        
        return super.lbl_PartialAdjustment();
    }
    ...
    @Override
    protected int lbl_Processing() {
        
        return super.lbl_Processing();
    }
    ...
    @Override
    public void stack(AA_ADJUST_INTEREST_RATE_cl arg0) {
