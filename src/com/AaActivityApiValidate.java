...
import com.temenos.t24.AA_ACTIVITY_API_VALIDATE_cl;
import com.temenos.t24.component_AA_ActivityAPI_16_cl;
...
public class AaActivityApiValidate extends AA_ACTIVITY_API_VALIDATE_cl {
    ...
    @Override
    public component_AA_ActivityAPI_16_cl getAA_ActivityAPI() {
        
        return super.getAA_ActivityAPI();
    }
    ...
    @Override
    protected int lbl_CALL_VALIDATE_ACTION() {
        
        return super.lbl_CALL_VALIDATE_ACTION();
    }

    @Override
    protected int lbl_CHECK_API_ROUTINES() {
        
        return super.lbl_CHECK_API_ROUTINES();
    }

    @Override
    protected int lbl_CHECK_FOR_DUPLICATE_CONDS() {
        
        return super.lbl_CHECK_FOR_DUPLICATE_CONDS();
    }

    @Override
    protected int lbl_CHECK_MUTUALLY_EXCLUSIVE_CONDS() {
        
        return super.lbl_CHECK_MUTUALLY_EXCLUSIVE_CONDS();
    }

    @Override
    protected int lbl_CHECK_PROPERTY_CLASS() {
        
        return super.lbl_CHECK_PROPERTY_CLASS();
    }
    ...
    @Override
    protected int lbl_UPDATE_DUP_CHECK_LIST() {
        
        return super.lbl_UPDATE_DUP_CHECK_LIST();
    }
    ...
    @Override
    public void stack(AA_ACTIVITY_API_VALIDATE_cl arg0) {
