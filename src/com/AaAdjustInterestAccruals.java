...
import com.temenos.t24.AA_ADJUST_INTEREST_ACCRUALS_cl;
...
public class AaAdjustInterestAccruals extends AA_ADJUST_INTEREST_ACCRUALS_cl {
    ...
    @Override
    protected int lbl_CALL_EB_ACCRUAL_ADJUST() {
        
        return super.lbl_CALL_EB_ACCRUAL_ADJUST();
    }
    ...
    @Override
    protected int lbl_DO_ADJUSTMENT_BY_BILLS() {
        
        return super.lbl_DO_ADJUSTMENT_BY_BILLS();
    }

    @Override
    protected int lbl_GET_ADJUSTMENT_DATA() {
        
        return super.lbl_GET_ADJUSTMENT_DATA();
    }
    ...
    @Override
    public void stack(AA_ADJUST_INTEREST_ACCRUALS_cl arg0) {
