...
import com.temenos.t24.AA_ARR_PRODUCT_TRACKER_SELECT_cl;
...
public class AaArrProductTrackerSelect extends AA_ARR_PRODUCT_TRACKER_SELECT_cl {
    ...
    @Override
    protected int lbl_BUILD_ARR_LIST() {
        
        return super.lbl_BUILD_ARR_LIST();
    }

    @Override
    protected int lbl_BUILD_CONTROL_LIST() {
        
        return super.lbl_BUILD_CONTROL_LIST();
    }

    @Override
    protected int lbl_CLEAR_TRACKER_FILE() {
        
        return super.lbl_CLEAR_TRACKER_FILE();
    }

    @Override
    protected int lbl_LOAD_PRODUCT_CHG_LIST() {
        
        return super.lbl_LOAD_PRODUCT_CHG_LIST();
    }
    ...
    @Override
    public void stack(AA_ARR_PRODUCT_TRACKER_SELECT_cl arg0) {
